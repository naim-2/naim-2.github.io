...
- "View PDF" links for local certificate files
...
<div class="card cert-card reveal">
  ...
  <div class="cert-actions">
    <a href="path/to/cert.pdf" target="_blank" class="btn btn-ghost">View PDF</a>
  </div>
</div>
```
...
<div class="card reveal">
  <div class="ds-card">
    ...
    <div>
      ...
      <a href="link" target="_blank" class="btn btn-outline" style="font-size:.78rem;">View Project</a>
    </div>
  </div>
</div>
```
...
*Built with care by Naim Salim · abdulhakimnaim@gmail.com*
